...
The system consists of two Linux Ubuntu web servers running Apache. The two servers are hosted on a high speed backplane at Digital Ocean's NYC data center.  The systems are backed up nightly.
